...
class AddArticlePage extends StatefulWidget {
  // Dipanggil setelah artikel BERHASIL ditambahkan.
  // Menggantikan Navigator.pop(context, true) - halaman ini adalah
  // konten TAB (lewat IndexedStack di navigation.dart), bukan halaman
  // yang di-push, jadi pop() akan menutup seluruh Navigation dan
  // membawa kembali ke LoginPage yang ada di bawahnya di stack.
...
class _AddArticlePageState extends State<AddArticlePage> {
  ...
  Future<void> addArticle() async {
    ...
    if (response.statusCode == 200 || response.statusCode == 201) {
      ...
      // beri tahu Navigation bahwa artikel baru sudah ditambahkan
